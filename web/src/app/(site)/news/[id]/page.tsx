...
export const metadata: Metadata = {
  title: "Article | Fluxor",
  description: "Read the latest cryptocurrency news and market insights",
};

// News data - same as in the main news page
const newsData = [
  {
    id: 1,
      ...
      <div className="min-h-screen bg-darkmode pt-32 pb-16">
        <div className="container mx-auto max-w-4xl px-4">
          <div className="text-center">
            ...
            <p className="text-muted text-lg mb-8">The article you're looking for doesn't exist.</p>
            <Link 
              href="/news" 
      ...
      <div className="container mx-auto max-w-4xl px-4">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <span className="text-muted text-sm">{article.read_time} min read</span>
            <span className="text-muted text-sm">{new Date(article.date).toLocaleDateString()}</span>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-primary/20 rounded-full flex items-center justify-center">
                <Icon icon="tabler:user" width="24" height="24" className="text-primary" />
              </div>
              <div>
                <p className="text-white font-medium">Fluxor Editorial Team</p>
                <p className="text-muted text-sm">Published on {new Date(article.date).toLocaleDateString()}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <button className="flex items-center gap-2 text-muted hover:text-primary transition-colors">
                <Icon icon="tabler:bookmark" width="20" height="20" />
                Save
              </button>
            </div>
          </div>
        ...
        {/* Related Articles */}
        <div className="mt-16">
          <h3 className="text-white text-2xl font-bold mb-8">Related Articles</h3>
            ...
            {newsData
              ...
              .map(relatedArticle => (
                <Link 
                  ...
                  className="bg-dark_grey bg-opacity-50 rounded-lg p-6 hover:bg-opacity-70 transition-all duration-300"
                >
                  <div className="flex items-center gap-4 mb-3">
                    <span className="bg-primary/20 text-primary px-2 py-1 rounded text-xs font-medium">
                      {relatedArticle.category}
                    </span>
                    <span className="text-muted text-sm">{relatedArticle.read_time} min read</span>
                  </div>
